-- ============================================================================
-- Migration: MySQL to PostgreSQL Email Templates with Syntax Conversion
-- ============================================================================
-- Date: 2025-12-05
-- Description: Migrate email templates from MySQL (Jinja2/Ninja) to 
--              PostgreSQL (Scriban/Liquid) with syntax conversion
--
-- Source: MySQL import_pulse.email_templates (Jinja2/Ninja templates)
-- Target: PostgreSQL NotificationService.email_templates (Scriban/Liquid)
-- ============================================================================

-- ============================================================================
-- SYNTAX DIFFERENCES: Jinja2/Ninja vs Scriban/Liquid
-- ============================================================================
-- Most syntax is compatible, but there are a few key differences:
--
...
--
-- REQUIRES CONVERSION:
--   {% elif condition %}     -> {% elsif condition %}     (elif -> elsif)
--   {{ var|filter }}         -> {{ var | filter }}        (add spaces around pipe)
--   {% else if %}            -> {% elsif %}               (else if -> elsif)
--
-- UNSUPPORTED (must rewrite):
--   {% macro name() %}       -> (use includes or inline)
--   {% call name() %}        -> (use includes or inline)
--   {{ super() }}            -> (not supported)
--   {% set var = val %}      -> {% assign var = val %}    (set -> assign)
--   {% include "file" %}     -> (not supported in DB templates)
-- ============================================================================

-- ============================================================================
-- STEP 1: MySQL Query to Export Templates
-- ============================================================================
-- Run this in MySQL to get the raw template data as JSON for conversion:
/*
SELECT 
    id,
    name,
...
-- ============================================================================
-- STEP 2: PostgreSQL Migration Script
-- ============================================================================
-- This section contains the INSERT statements with converted syntax.
-- The templates below have been converted from Jinja2/Ninja to Scriban/Liquid.
...
-- ============================================================================
-- Template: Census Processing Complete (Full Template)
-- ============================================================================
-- This is the main daily import report template with full body content.
-- Converted from Jinja2 to Scriban/Liquid syntax.
...
-- ============================================================================
-- Run these after migration to verify the data:

-- Check template count
-- SELECT COUNT(*) as template_count FROM email_templates;

-- Check specific template content length
-- SELECT name, LENGTH(html_content) as html_length FROM email_templates ORDER BY name;

-- Verify the full template was imported
-- SELECT name, LEFT(html_content, 200) as html_preview FROM email_templates WHERE name = 'Census Processing Complete';
